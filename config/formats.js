...
exports.Formats = [
	...
	},
	{
		...
		desc: [
			...
			"Ashley the Pikachu (Head Researcher, Began the project, Attack Manual, Type Chart Manual, Music Selection and Music HTML, Sprite Selection), Insist (Head Developer), AlphaStorm (Animations), Eelek (Assisted other developers), HoeenHero (Assisted with Mechanics)",
		],
