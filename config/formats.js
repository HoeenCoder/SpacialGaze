...
exports.Formats = [
	...
	// Seasonal
	{
		...
		desc: [
			...
			"Oh, and pokemon are representatives of Countries and will try to conquer each other!",
			"Credits: Spandan for the code for metaman. VXN for the concept and adding the countries.",
		],
		team: 'randomcountry',
