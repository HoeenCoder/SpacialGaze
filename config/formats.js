...
exports.Formats = [
	...
	// SpacialGaze Metagames
	{
		...
		ruleset: ['[Gen 7] OU'],
		banlist: ['Aguav Berry', 'Assualt Vest', 'Berry Juice', 'Cheek Pouch', 'Dry Skin', 'Ice Body', 'Poison Heal', 'Regenerator', 'Volt Absorb', 'Water Absorb', 'Rain Dish', 'Blace Sludge', 'Enigma Berry', 'Figy Berry', 'Iapapa Berry', 'Mago Berry', 'Oran Berry', 'Shell Bell', 'Sitrus Berry', 'Wiki Berry', 'Leftovers'],
		mod: 'metronome',
		...
		onBegin: function () {
			...
			allPokemon.forEach(pokemon => {
				...
				if (this.getFormat('gen7metronomebattle').banlist.includes(this.getItem(pokemon.item).name)) {
