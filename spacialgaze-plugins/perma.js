...
exports.commands = {
	...
	permalock: function (target, room, user, connection, cmd) {
		...
		if (cmd === 'offlinepermalock' || cmd === 'forceofflinepermalock') {
			...
			Monitor.adminlog('[PermaMonitor] ' + user.name + ' has (offline) permalocked ' + target + '.');
		...
		Monitor.adminlog('[PermaMonitor] ' + user.name + ' has permalocked ' + tarUser.name + '.');
	...
	unpermalock: function (target, room, user, connection, cmd) {
		...
		Monitor.adminlog('[PermaMonitor] ' + user.name + ' has unpermalocked ' + target + '.');
	...
	permaban: function (target, room, user, connection, cmd) {
		...
		if (cmd === 'offlinepermaban' || cmd === 'forceofflinepermaban') {
			...
			Monitor.adminlog('[PermaMonitor] ' + user.name + ' has (offline) permabanned ' + target + '.');
		...
		Monitor.adminlog('[PermaMonitor] ' + user.name + ' has permabanned ' + tarUser.name + '.');
	...
	unpermaban: function (target, room, user, connection, cmd) {
		...
		Monitor.adminlog('[PermaMonitor] ' + user.name + ' has unpermabanned ' + target + '.');
