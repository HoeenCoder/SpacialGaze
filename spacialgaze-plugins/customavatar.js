...
exports.commands = {
	customavatar: {
		set: function (target, room, user) {
			...
			if (fs.existsSync((AVATAR_PATH + name + ext))) return this.popupReply("|html|<center>" + SG.nameColor(name, true, true) + " already has a custom avatar.<br /> Use /customavatar delete [username] to delete it.</center>");
